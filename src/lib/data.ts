...
export const MOCK_QUESTIONS: Omit<Question, "id" | "createdAt">[] = [
  ...
  { question: "¿Cómo diseñarías un sistema de notificaciones?", answer: "Componentes: 1) API que recibe eventos (nueva postulación, entrevista programada), 2) Cola de mensajes (RabbitMQ/SQS) para desacoplar, 3) Workers que procesan la cola y envían por canal (email/push/SMS), 4) Template engine para personalizar mensajes, 5) Preferencias del usuario (qué notificaciones quiere), 6) Rate limiting para no spamear. Patrón: Event-driven con pub/sub.", tags: ["System Design"] },
